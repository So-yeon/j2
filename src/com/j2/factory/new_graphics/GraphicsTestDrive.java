...
public class GraphicsTestDrive{
  public static void main (String[] args){
    ...
    System.out.println("Soyeon want see a " + graphics + "'s effect \n");
    
    graphics = triangle.effectGraphics("triangle");
    System.out.println("Siwoo want see a " + graphics + "'s effect\n"); 
    
    graphics = square.effectGraphics("square");
    System.out.println("Sohee want see a " + graphics + "'s effect \n"); 
  }
}